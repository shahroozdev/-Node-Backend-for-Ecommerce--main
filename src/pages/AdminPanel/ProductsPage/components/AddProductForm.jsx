...
const AddProductForm = ({ isOpen, onClose, allCategories , defaultValue, getAllProducts}) => {
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      if(defaultValue){
        await apiClient.put({url:`/products/${defaultValue._id}`, data:formDataToSend, headers:{'Content-Type': 'multipart/form-data'}});
      }else{
        await apiClient.post({url:"/products", data:formDataToSend, headers:{'Content-Type': 'multipart/form-data'}});
      }
      onClose();
    } catch (error) {
