  ...
  return (
    <div className="w-full relative">
        ...
        <div className="space-y-4 md:ml-[12rem] sm:fixed left-0 top-0 w-full bg-white md:max-w-[calc(100%-12rem)] z-20 p-4">
          <div className="flex sm:flex-row flex-col justify-between sm:items-center gap-4">
            ...
            <div className="flex items-center gap-5">
              ...
              <button
                onClick={() => setShowAddProductModal({status:true, defaultValues:null})}
                className="btn1 bg-primary text-white hover:bg-primary/90"
              >
          ...
          <div className="flex sm:flex-row flex-col sm:items-center gap-3">
            <div className="flex items-center gap-2 p-2 rounded border">
              ...
              <input
                ...
                onChange={(e)=>setFilteredProducts(allProducts.filter(ele=>(ele.name.toLowerCase().includes(e.target.value.toLowerCase()))))}
              />
            </div>
            ...
            <button className="btn1 bg-gray-500 text-white hover:bg-gray-600 h-fit" onClick={()=>{setFilteredProducts(allProducts); setSelectedDropdownCategory('All')}}>
              Reset
            </button>
          </div>
        </div>
      ...
      <AddProductForm
        ...
        onClose={() => setShowAddProductModal({status:false, defaultValues:null})}
      ...
      <AddCategoryForm
        ...
        onClose={() => {setShowAddCategoryModal(false);getAllCategories()}}
      />
    </div>
  );
};
